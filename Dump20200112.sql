...
CREATE TABLE `evaluationreport` (
  ...
  KEY `requestIDEvaluationReportFK` (`requestID`),
  CONSTRAINT `requestIDEvaluationReportFK` FOREIGN KEY (`requestID`) REFERENCES `changerequest` (`requestID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `evaluationreport` VALUES ('awd','awd','awd','2020-01-22 01:30:00',1,6,'dawd','dwa');
...
CREATE TABLE `executionreport` (
  ...
  `place` varchar(256) NOT NULL,
  PRIMARY KEY (`reportID`),
  KEY `requestIDExecutionReportFK` (`requestID`),
  CONSTRAINT `requestIDExecutionReportFK` FOREIGN KEY (`requestID`) REFERENCES `changerequest` (`requestID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=54391 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `phase` VALUES (1,6,'Evaluation','Closed',10,'2020-01-29 01:30:00','2020-01-29 01:30:00','1999-01-01 02:30:00','2020-01-12 14:30:23',0),(2,6,'Evaluation','Closed',22,'2020-01-19 14:43:28','2020-01-19 14:43:28','1999-01-01 02:30:00','2020-01-12 14:43:28',0),(3,7,'Decision','Waiting To Set Time Required For Evaluation',10,'1999-01-01 02:30:00','1999-01-01 02:30:00','1999-01-01 02:30:00','2020-01-12 16:04:06',0);
...
-- Dump completed on 2020-01-12 22:37:15
