...
public class EvaluationReportReviewPage1Controller implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		hbNextPage.setOnMousePressed(event -> {
			ControllerSwapper.loadAnchorContent(vbEvalReportPage1Container, FxmlNames.EVALUATION_REPORT_REVIEW_PAGE_2);
